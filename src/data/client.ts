...
export const BUSINESS = {
	...
	email: "hello@greencovedigital.com",
	logo: "/favicon.svg",
...
export const OG = {
	locale: "en_US",
	/**
	 * Generated by `pnpm og` from the site's own hero vocabulary — see
	 * docs/og-image.md. Scrapers cache aggressively and key on the URL, so
	 * regenerating after launch means bumping to `/og-2.png`, not overwriting.
	 */
	image: "/og.png",
	width: 1200,
	height: 630,
	alt: "Green Cove Digital — small business websites",
};
